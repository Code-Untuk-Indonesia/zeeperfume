    ...
    <div class="flex-1 overflow-y-auto p-4 lg:p-8 bg-[#FAFAFA] w-full">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Tambahkan data pelanggan untuk program loyalitas dan diskon khusus.
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col xl:flex-row gap-6 max-w-5xl mx-auto">
            ...
            <div class="flex-1 bg-white p-6 md:p-8 rounded-3xl border border-gray-100 shadow-sm">
                <!-- UBAH ACTION DI SINI -->
                <form action="{{ route('kasir.member.store') }}" method="POST">
                    @csrf
                    <div class="space-y-6">
                        ...
                        <div class="bg-blue-50/50 p-4 rounded-2xl border border-blue-100 flex gap-3">
                            ...
                            <p class="text-xs text-gray-600 leading-relaxed">
                                Pastikan nomor WhatsApp aktif untuk pengiriman struk digital dan promo.
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#CC9863]/50 focus:border-[#CC9863] transition"
                                    placeholder="Contoh: Rina Melati" required onkeyup="updateCardName(this.value)">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" name="phone" value="{{ old('phone') }}"
                                    class="w-full px-4 py-3 border {{ $errors->has('phone') ? 'border-red-500 bg-red-50' : 'border-gray-200 bg-gray-50' }} rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#CC9863]/50 focus:border-[#CC9863] transition"
                                    placeholder="08xxx" required onkeyup="updateCardPhone(this.value)">
                                @error('phone')
                            ...
                            <div>
                                ...
                                <input type="date" name="dob" value="{{ old('dob') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#CC9863]/50 focus:border-[#CC9863] transition text-gray-700">
                            </div>

                            <!-- Alamat -->
                            <div class="md:col-span-2">
                                <label class="block text-sm font-semibold text-gray-700 mb-1">Alamat Singkat <span
                                        class="text-gray-400 font-normal">(Opsional)</span></label>
                                <input type="text" name="address" value="{{ old('address') }}"
                                    class="w-full px-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-[#CC9863]/50 focus:border-[#CC9863] transition"
                                    placeholder="Contoh: Jl. Ahmad Yani, Pontianak">
                            </div>
                        </div>
            ...
            <div class="w-full xl:w-[380px] shrink-0 space-y-6">
                ...
                <div
                    class="bg-gradient-to-br from-[#1C1D21] to-gray-800 p-6 rounded-3xl shadow-xl text-white relative overflow-hidden h-52 flex flex-col justify-between">
                    ...
                    <div class="relative z-10">
                        ...
                        <h3 id="card-name" class="text-xl font-bold text-white uppercase tracking-wider mb-2 truncate">NAMA
                            PELANGGAN</h3>
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
                    <h3 class="text-sm font-bold text-gray-900 mb-4 border-b border-gray-100 pb-3">Konfirmasi Pendaftaran
                    </h3>
                    <div class="flex flex-col gap-3">
                        <button type="submit"
                            class="w-full bg-[#CC9863] text-white py-3.5 rounded-xl font-bold hover:bg-[#b58555] transition shadow-[0_4px_15px_rgba(204,152,99,0.4)] flex items-center justify-center gap-2">
                        ...
                        <a href="{{ url('kasir/pos') }}"
                            class="w-full bg-white text-gray-700 py-3.5 rounded-xl font-bold hover:bg-gray-50 transition text-center border border-gray-200">
                            Batal
                        </a>
                    </div>
                </div>
