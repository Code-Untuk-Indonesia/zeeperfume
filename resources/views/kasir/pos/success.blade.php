...
<div class="flex-1 overflow-y-auto p-4 lg:p-8 bg-[#FAFAFA] w-full flex items-center justify-center h-full">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-xl w-full max-w-lg overflow-hidden relative">
        ...
        <div class="p-8 md:p-10 relative z-10 flex flex-col items-center text-center">
            ...
            <p class="text-gray-500 text-sm mb-8">No. Invoice: <span class="font-bold text-gray-700">INV-2609-043</span></p>
            ...
            <div class="w-full bg-gray-50 rounded-2xl p-5 mb-8 border border-gray-100">
                <div class="flex justify-between items-center mb-3">
                    ...
                    <span class="text-sm font-bold text-gray-900">Rp 900.000</span>
                </div>
                <div class="flex justify-between items-center mb-4">
                    <span class="text-sm font-semibold text-gray-500">Uang Diterima (Tunai)</span>
                    <span class="text-sm font-bold text-gray-900">Rp 1.000.000</span>
                </div>
                <div class="w-full h-px bg-gray-200 border-dashed border-b border-gray-300 mb-4"></div>
                <div class="flex justify-between items-center bg-green-50/50 p-3 rounded-xl border border-green-100">
                    <span class="text-sm font-bold text-gray-700">Kembalian</span>
                    <span class="text-2xl font-extrabold text-green-600">Rp 100.000</span>
                </div>
            </div>

            <!-- Tombol Aksi -->
            <div class="w-full space-y-3">
                <!-- Tombol Cetak (Akan memanggil window.print JS) -->
                ...
                <div class="grid grid-cols-2 gap-3">
                    <button class="w-full bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 py-3.5 rounded-xl font-bold hover:bg-[#25D366]/20 transition flex justify-center items-center gap-2 text-sm">
                    ...
                    <!-- Link Kembali ke POS -->
                    <a href="{{ url('kasir/pos') }}" class="w-full bg-[#CC9863] text-white py-3.5 rounded-xl font-bold hover:bg-[#b58555] transition flex justify-center items-center text-sm shadow-sm">
                        Transaksi Baru
                    </a>
                </div>
            </div>
