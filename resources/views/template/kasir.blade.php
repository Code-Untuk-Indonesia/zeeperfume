            ...
            >
                ...
                >
                    ...
                    <a
                        href="{{ url('kasir/pos') }}"
                        class="
                            {{ request()->is('kasir/pos*') || request()->is('kasir/member*')
                                ? 'bg-[#CC9863] text-white shadow-sm'
                    ...
                    <!-- TRANSACTION HISTORY -->
                    <a
                        href="{{ url('kasir/transaction') }}"
                        class="
                            {{ request()->is('kasir/transaction*')
                                ? 'bg-[#CC9863] text-white shadow-sm'
                                : 'text-gray-300 hover:bg-gray-800 hover:text-white'
                            }}
                    ...
                    >
                        ...
                        <button
                            ...
                            class="
                                ...
                                focus-visible:ring-[#CC9863]
                                focus-visible:outline-none
                            "
                            title="Tutup Kasir / Logout"
