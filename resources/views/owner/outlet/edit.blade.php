            ...
            <fieldset class="space-y-2">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="jam_buka" type="time" name="jam_buka" value="{{ old('jam_buka', substr((string) $outlet->jam_buka, 0, 5)) }}" aria-describedby="jam-operasional-hint" class="w-full min-h-12 px-4 py-3 border border-gray-500 rounded-xl bg-gray-50 text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-[#CC9863] transition">
                    </div>
                    <div>
                        <label for="jam_tutup" class="block text-sm font-semibold text-gray-700 mb-1.5">Jam tutup</label>
                        <input id="jam_tutup" type="time" name="jam_tutup" value="{{ old('jam_tutup', substr((string) $outlet->jam_tutup, 0, 5)) }}" aria-describedby="jam-operasional-hint" class="w-full min-h-12 px-4 py-3 border border-gray-500 rounded-xl bg-gray-50 text-gray-900 focus:bg-white focus:outline-none focus:ring-2 focus:ring-gray-800 focus:border-[#CC9863] transition">
                    </div>
                </div>
            </fieldset>
            <div>
