    ...
    <main class="flex-1 bg-[#FAFAFA] overflow-y-auto px-4 lg:px-10 py-6 lg:py-8 w-full">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
                ...
                <p class="text-gray-500 text-sm mt-1">Kelola informasi, lokasi, dan status operasional seluruh cabang toko
                    Anda.</p>
            </div>
            <a href="{{ url('owner/outlet/create') }}"
                    ...
                    <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-orange-50 flex items-center justify-center text-[#CC9863] font-bold shrink-0">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                                            </path>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <p class="text-xs text-gray-500 max-w-[200px] truncate"
                                    title="Jl. Jend. Sudirman No. 1, Pontianak">Jl. Jend. Sudirman No. 1, Pontianak</p>
                            </td>
                            <td class="px-6 py-4">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-blue-500 font-bold shrink-0">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                                            </path>
                            ...
                            <td class="px-6 py-4">
                                ...
                                <p class="text-xs text-gray-500 max-w-[200px] truncate"
                                    title="Ayani Megamall Lantai 1, Pontianak">Ayani Megamall Lantai 1, Pontianak</p>
                            </td>
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 transition bg-gray-50/50">
                            <td class="px-6 py-4 opacity-60">
                                <div class="flex items-center gap-3">
                                    <div
                                        class="w-12 h-12 rounded-xl bg-gray-200 flex items-center justify-center text-gray-500 font-bold shrink-0">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4">
                                            </path>
                            ...
                            <td class="px-6 py-4 opacity-60">
                                ...
                                <p class="text-xs text-gray-500 max-w-[200px] truncate" title="Jl. Gajah Mada, Pontianak">
                                    Jl. Gajah Mada, Pontianak</p>
                            </td>
                            <td class="px-6 py-4 opacity-60">
                                <div class="flex items-center gap-2">
