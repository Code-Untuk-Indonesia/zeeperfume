...
<main class="flex-1 bg-[#FAFAFA] overflow-y-auto px-4 lg:px-10 py-6 lg:py-8 w-full relative">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
            <a href="{{ url('admin/outlet') }}" class="hover:text-[#CC9863] transition">Manajemen Outlet</a>
    ...
    <form action="#" method="POST" class="flex flex-col xl:flex-row gap-6">
        ...
        <div class="w-full xl:w-[400px] space-y-6 shrink-0">
            ...
            <div class="flex gap-3">
                <a href="{{ url('admin/outlet') }}" class="flex-1 bg-white border border-gray-200 text-center text-gray-700 py-3.5 rounded-2xl font-bold hover:bg-gray-50 transition shadow-sm">
                    Batal
                </a>
