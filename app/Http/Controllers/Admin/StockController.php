...
class StockController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.stock.index', compact('products', 'categories', 'branches', 'totalProducts', 'lowStockCount'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->variants as $varId => $varData) {
                ...
                // Simpan Varian (Gunakan ?: 0 agar String Kosong "" otomatis jadi 0)
                $variant = ProductVariant::create([
                    'produk_id'   => $product->id,
                    'nama_varian' => $varData['name'],
                    'sku'         => $varData['sku'] ?? null,
                    'harga_beli'  => $varData['cost'] ?: 0,
                    'harga_jual'  => $varData['price'] ?: 0,
            ...
            DB::commit();
            return redirect()->route('admin.stock.index')->with('success', 'Produk dan Varian berhasil disimpan!');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    public function edit($id)
    {
        ...
        $categories = Category::all();
        $branches = Branch::all();
        return view('admin.stock.edit', compact('product', 'categories', 'branches'));
    }
